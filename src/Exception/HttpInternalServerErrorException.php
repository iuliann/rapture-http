 ...
 * @license LICENSE MIT
 */
class HttpInternalServerErrorException extends \Exception implements HttpExceptionInterface
{
    ...
    {
        parent::__construct($message ?: 'Internal Server Error', 500, $previous);
    }
}
